// ==============================================
// GET /api/tokens
// The motion set as structured JSON, for agents and
// scripts that want data rather than a page.
//
// Same query contract as the site itself, so an agent
// handed a share link can swap "/" for "/api/tokens"
// and get the machine-readable form. Pure function of
// the query string — no state, no storage — so
// responses cache indefinitely.
// ==============================================
